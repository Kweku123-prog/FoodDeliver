...
class CartHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<int>cartItemsPerOrderToList(){
      // return cartItemsPerOrder.entries.map((e)=>).toList();
        ...
        children: [
          ...
          GetBuilder<CartController>(builder: (_cartController){
            return _cartController.getCartHistoryList().length>0?Expanded(
                                            ...
                                            children: [
                                              ...
                                              GestureDetector(
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    borderRadius: BorderRadius.circular(Dimensions.raduis15/3),
                ...
                child: Center(child: NoDataPage(text: "Empty History  ",imgPath: "assets/image/empty_box.png",)));
          })
        ],
      ),
