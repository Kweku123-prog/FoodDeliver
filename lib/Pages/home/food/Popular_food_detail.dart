...
class PopularFoodDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Get.find<PopularPorductController>().initProduct(product,Get.find<CartController>());
    ...
    return Scaffold(
      ...
      bottomNavigationBar: GetBuilder<PopularPorductController>(builder: (popularProduct){
        return Container(
