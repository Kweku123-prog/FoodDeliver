...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  double _height =Dimensions.pageViewConatiner;
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        //Slider
       GetBuilder<PopularPorductController>(
    ...
    GetBuilder<PopularPorductController>(builder: (popularProducts){
                           ...
                           Padding(
                             ...
                             child: Column(
                               ...
                               children: [
                                 ...
                                 SmallText(text: "With Ghanaian Characteristics"),
...
Get.toNamed(RouteHelper.getPopularFood(index,'home '));
      ...
      height: Dimensions.pageViewConatiner,
      ...
      Align(
        ...
        child: Container(
          ...
          height: Dimensions.pageViewTextConatiner,
